	...
	return (
		<header
			className={cn(
				...
				{
					'bg-white/80 dark:bg-slate-950/80 supports-[backdrop-filter]:bg-background/50 border-slate-200 dark:border-slate-800 backdrop-blur-lg md:top-4 md:max-w-5xl md:rounded-2xl md:border md:shadow-2xl':
						scrolled && !open,
