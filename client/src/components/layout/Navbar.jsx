...
const Navbar = () => {
    ...
    return (
        <>
        <header className="font-nav h-14 md:h-16 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 sticky top-0 z-30 transition-all duration-300 min-w-0 shrink-0">
