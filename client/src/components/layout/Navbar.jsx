...
const Navbar = () => {
    ...
    return (
        <>
        <header className="font-nav min-h-14 md:min-h-16 h-[calc(3.5rem+env(safe-area-inset-top))] md:h-[calc(4rem+env(safe-area-inset-top))] bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 sticky top-0 z-30 pt-[env(safe-area-inset-top)] transition-all duration-300 min-w-0 shrink-0">
