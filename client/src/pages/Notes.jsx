    ...
    return (
        <div className="max-w-6xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 pb-6 border-b border-slate-200 dark:border-slate-800">
                ...
                <button 
                    onClick={handleSave}
                    className="px-10 py-5 bg-slate-900 dark:bg-slate-800 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-violet-600 transition-all shadow-2xl shadow-slate-200 dark:shadow-none flex items-center gap-3 btn-hover-scale"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="bg-white dark:bg-slate-900 premium-shadow p-12 rounded-3xl border border-slate-100 dark:border-slate-800 space-y-10 transition-all">
                ...
                <div className="bg-slate-900 p-12 rounded-3xl border border-slate-800 shadow-3xl space-y-10 text-white relative overflow-hidden group transition-all">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-violet-500/5 rounded-full blur-3xl group-hover:scale-150 transition-transform duration-1000"></div>
                    ...
                    <textarea 
                        ...
                        className="w-full h-[500px] bg-white/5 border border-white/10 rounded-2xl p-10 text-sm font-bold text-violet-100 focus:ring-4 focus:ring-violet-500/10 transition-all resize-none placeholder-violet-300/10 leading-relaxed font-mono relative z-10 outline-none"
                    />
                    <div className="pt-4 flex items-center gap-5 text-[10px] font-black text-violet-400 uppercase tracking-[0.3em] relative z-10">
            ...
            <div className="p-10 bg-slate-100/50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-700 flex items-center gap-8 group transition-all">
