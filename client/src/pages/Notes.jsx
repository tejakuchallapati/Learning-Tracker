    ...
    return (
        <div className="max-w-6xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 pb-6 border-b border-slate-100 dark:border-slate-800">
                ...
                <button 
                    onClick={handleSave}
                    className="px-10 py-5 bg-slate-900 text-white rounded-[2rem] font-black text-[10px] uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-2xl shadow-slate-200 flex items-center gap-3 btn-hover-scale"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="bg-slate-900 p-12 rounded-[4rem] border border-slate-800 shadow-3xl space-y-10 text-white relative overflow-hidden group">
                    ...
                    <textarea 
                        ...
                        className="w-full h-[500px] bg-white/5 border border-white/10 rounded-[3rem] p-10 text-sm font-bold text-indigo-100 focus:ring-4 focus:ring-indigo-500/10 transition-all resize-none placeholder-indigo-300/10 leading-relaxed font-mono relative z-10"
                    />
