        ...
        <div className={PAGE_SHELL}>
            ...
            <div className={`max-w-2xl rounded-2xl p-4 border flex flex-col sm:flex-row sm:items-center justify-between gap-3 ${
                ...
                {user?.isAdmin ? (
                    <Link
                        to="/admin"
                        className="shrink-0 inline-flex items-center justify-center min-h-[44px] px-4 py-2.5 bg-violet-600 text-white rounded-xl font-bold text-sm hover:bg-violet-700 transition-all text-center"
                    >
                        Open admin panel
                    </Link>
                ) : null}
